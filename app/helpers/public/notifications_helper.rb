module Public::NotificationsHelper
  def notification_form(notification)
    ...
    when "comment" then
      ...
      tag.a(@visiter.name, href: listener_path(@visiter),class:"notification_text link p-0")
      + "が" + tag.a('あなたの投稿', href: post_path(notification.post_id),class:"notification_text link p-0") + "にコメントしました"
    end
  end
